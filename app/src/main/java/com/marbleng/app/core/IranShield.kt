...
object IranShield {
    ...
    fun countermeasures(state: IranModeState): List<String> {
        ...
        out += "Survival-first ranking: timeout-probed servers are kept as 'uncertain', not eliminated"
        ...
        out += "Domestic (geoip:ir) traffic routed direct to cut tunnel volume and extend server lifetime"
