...
private val EnglishStrings = MarbleStrings(
    ...
    noServersBody = "Hold the clipboard button to add a subscription, paste a config or import a file.",
    ...
    proServerRailDetail = "Servers chosen in the Servers tab",
...
private val PersianStrings = MarbleStrings(
    ...
    noServersBody = "دکمه کلیپ‌بورد را چند لحظه نگه دارید تا ساب اضافه کنید، پیکربندی بچسبانید یا فایل وارد کنید.",
    ...
    proServerRailDetail = "سرورهای انتخابی برگه سرورها",
