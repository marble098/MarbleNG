...
data class MarbleStrings(
    ...
    val styleIosSlider: String,
    val styleIosSliderDetail: String,
    val styleIosFloating: String,
    val styleIosFloatingDetail: String,
    val styleIosEmbossed: String,
    ...
    // iOS 4 Themes actions & indicators
    val socksProxyLabel: String,
    val socksCopied: String,
    val quickAddConnect: String,
    val slideToConnect: String,
    val slideToDisconnect: String,
    val customizeLayout: String,

    // MARBLE_SIGNATURE_STUDIO_REMOVED_V143 — the Signature studio surface is permanently removed.
...
private val EnglishStrings = MarbleStrings(
    ...
    serversSubtitle = "Subscriptions and manual servers",
    ...
    homeStyleDetail = "Four iOS-styled connection presentations",
    styleIosSlider = "Theme 1 (Slider)",
    styleIosSliderDetail = "Slide to connect with centered sub server deck",
    styleIosFloating = "Theme 2 (Floating)",
    styleIosFloatingDetail = "Right floating button that splits to pause & ping on connect",
    styleIosEmbossed = "Theme 3 (Embossed)",
    ...
    socksProxyLabel = "SOCKS5 Proxy",
    socksCopied = "SOCKS proxy address copied",
    quickAddConnect = "Quick Add & Connect",
    slideToConnect = "Slide to connect",
    slideToDisconnect = "Slide to disconnect",
    customizeLayout = "Customize Layout",

    // MARBLE_SIGNATURE_STUDIO_REMOVED_V143
...
private val PersianStrings = MarbleStrings(
    ...
    dataFlow = "جریان داده",
    appearance = "ظاهر",
    homeStyleTitle = "طرح‌بندی صفحه اصلی",
    homeStyleDetail = "چهار تم با طراحی باکس‌های شیشه‌ای iOS",
    styleIosSlider = "تم شماره ۱ (اسلایدر)",
    styleIosSliderDetail = "دکمه کشیدنی اتصال و لیست سرورهای ساب",
    styleIosFloating = "تم شماره ۲ (شناور)",
    styleIosFloatingDetail = "دکمه شناور با انیمیشن تبدیل به قطع و پینگ و لیست عریض سرورها",
    styleIosEmbossed = "تم شماره ۳ (برجسته)",
    ...
    socksCopied = "آدرس پروکسی SOCKS کپی شد",
    quickAddConnect = "افزودن سریع و اتصال",
    slideToConnect = "برای اتصال بکشید",
    slideToDisconnect = "برای قطع اتصال بکشید",
