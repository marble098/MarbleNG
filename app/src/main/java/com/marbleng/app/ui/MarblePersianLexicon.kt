...
private val FaLexicon: Map<String, String> = mapOf(
    ...
    "Paste the https:// link of the subscription." to "لینک https:// اشتراک را بچسبانید.",
    "Scan QR code" to "اسکن کد QR",
    "Point the camera at the code" to "دوربین را روی کد بگیرید",
    "Starting the camera…" to "در حال راه‌اندازی دوربین…",
    "No camera is available on this device" to "دوربینی روی این دستگاه در دسترس نیست",
    "The camera could not start • use the gallery" to "دوربین راه نیفتاد • از گالری استفاده کنید",
    "Choose from gallery" to "انتخاب از گالری",
    "QR code from gallery" to "کد QR از گالری",
    "Pick a screenshot or photo of the code" to "یک اسکرین‌شات یا عکس از کد انتخاب کنید",
    "Camera permission is needed to scan a code • the gallery works without it" to
        "برای اسکن کد به دسترسی دوربین نیاز است • گالری بدون آن کار می‌کند",
    "That does not look like a subscription link yet." to "این هنوز شبیه لینک اشتراک نیست.",
    "Remote subscriptions must use HTTPS." to "اشتراک راه دور باید از HTTPS استفاده کند.",
    "Servers will be added as a new group and refreshed." to
        "سرورها به‌عنوان یک گروه جدید افزوده و به‌روزرسانی می‌شوند.",
    "Saves into" to "ذخیره در",
    "Duplicate server" to "تکثیر سرور",
    "Edit server" to "ویرایش سرور",
    "Edit Xray JSON" to "ویرایش JSON اکس‌ری",
    "Effective config JSON" to "JSON پیکربندی نهایی",
    "Your server • edits are stored locally." to "سرور شما • ویرایش‌ها به‌صورت محلی ذخیره می‌شوند.",
