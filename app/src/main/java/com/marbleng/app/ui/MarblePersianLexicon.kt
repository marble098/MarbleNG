...
private val FaLexicon: Map<String, String> = mapOf(
    ...
    "What this tab opens" to "این تب چه چیزی را باز می‌کند",
    "Choose the job this slot does; then pick its target below" to "کار این جایگاه را انتخاب کنید و سپس مقصد آن را برگزینید",
    "Choose the target" to "انتخاب مقصد",
    "Live route telemetry follows the connection automatically" to "اطلاعات مسیر زنده به‌صورت خودکار اتصال را دنبال می‌کند",
    "Pin one subscription or the whole library" to "یک اشتراک یا کل کتابخانه را ثابت کنید",
    "Pin one saved config for one-tap access" to "یک کانفیگ ذخیره‌شده را برای دسترسی یک‌ضربه‌ای ثابت کنید",
    "The pulse follows the route carrying traffic and keeps library tools one tap away." to
        "نبض، مسیر در حال عبور ترافیک را دنبال می‌کند و ابزارهای کتابخانه را یک‌ضربه‌ای در دسترس می‌گذارد.",
    "Name and symbol" to "نام و نماد",
    "Make the slot recognizable in the narrow bottom bar" to "جایگاه را در نوار باریک پایین به‌آسانی تشخیص دهید",
    "Color and status" to "رنگ و وضعیت",
    "Give the fourth destination its own accent and live indicator" to "برای مقصد چهارم رنگ و نشانگر زندهٔ جداگانه انتخاب کنید",
    "Accent color" to "رنگ تأکیدی",
    "Live connection dot" to "نشانگر زندهٔ اتصال",
    "Show connected, connecting or stopped state on the fourth tab icon." to
        "وضعیت اتصال، در حال اتصال یا توقف را روی آیکون تب چهارم نشان بده.",
    "Ocean" to "اقیانوسی",
    "Mint" to "نعنایی",
    "Violet" to "بنفش",
    "Bearing" to "قطب‌نما",
